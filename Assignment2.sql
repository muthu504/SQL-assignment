...
VALUES ('KORRAI','gowtham','VIZAG','INDIA','8639293390'),
('K','SHINNY','Mani','INDIA','8639293390'),
('B','srinivasav rao','CHEENAI','UK','030-0074321'),
('A','bindhu','BANGALORE','GERMANY','7894561230'),
('MAHINDRA','DHONI','PUNE','INDIA','1234567890');
('ravipalli','vagdevi','PUNE','INDIA','7416934679');
